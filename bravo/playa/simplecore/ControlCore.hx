...
class ControlCore extends Core
{
	...
	function InfoDisplay()
	{
		...
		audioBg.addChild(masker);
		audioBg.mask = masker;
		audioBg.graphics.lineStyle(0, TextConfig.leftColor);
		audioBg.graphics.beginFill(TextConfig.leftColor);
		audioBg.graphics.drawRect(0, 0, width / 2, height);
		audioBg.graphics.endFill();
		audioBg.graphics.lineStyle(0, TextConfig.rightColor);
		audioBg.graphics.beginFill(TextConfig.rightColor);
		audioBg.graphics.drawRect(width / 2, 0, width / 2, height);
		audioBg.graphics.endFill();
